...
const RealeatedDoctors = ({ speciality, docId }) => {
  ...
  useEffect(() => {
    if (doctors.length > 0 && speciality) {
      ...
      setRelDoc(doctorData); // Update the related doctors list
    }
  }, [doctors, speciality, docId]); // Dependencies

  return (
    <div className="flex flex-col items-center gap-4 my-16 text-grey-900">
...
export default RealeatedDoctors;
